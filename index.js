...
app.post('/drain/fet7jr4ho98tf3', function (req, res) {
    ...
    if (metric) {
        ...
        pg.connect(process.env.DATABASE_URL, function (err, client, done) {
            ...
            app.pgClient.query(`
            INSERT INTO metrics (type, date, source, status, service, memory, memoryquota, load) VALUES
            (${metric.type}, ${metric.date}, ${metric.source}, ${metric.status},
            ${metric.service}, ${metric.memory}, ${metric.memoryquota}, ${metric.load})`, function (err, result) {
                if (err) {
